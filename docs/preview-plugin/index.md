...
The preview reads mesh data from `BPI_ModularCharacterPreview` implemented on your Character. The interface returns the Main Mesh, Follower Meshes array, Face Mesh, and Groom Components array.
...
- Multiplayer-safe (client-local preview, no replication required)
